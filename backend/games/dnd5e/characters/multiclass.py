...
from backend.games.dnd5e.characters.character_data import full_caster_slots, get_class
from backend.games.dnd5e.characters.entity import ABILITY_KEYS, Dnd5eCharacter
...
def asi_feat_slots_multiclass(char: Dnd5eCharacter) -> int:
    from backend.games.dnd5e.characters.character_builder import asi_feat_slots
