...
from backend.games.dnd5e.characters.character_builder import apply_short_rest, long_rest_recover
...
from backend.games.dnd5e.dm.resource_keeper import apply_cast_spell_shortcut
