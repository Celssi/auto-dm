...
SPECIES = [
    ...
    },
    {
        ...
        "speed": 30,
        "size_options": ["medium"],
        "traits": ["Darkvision 60 ft.", "Fey Ancestry", "Keen Senses", "Trance"],
    },
    {
        "id": "gnome",
        "label": "Gnome",
    ...
    },
    {
        ...
        "speed": 35,
        "size_options": ["medium"],
        "traits": ["Giant Ancestry", "Large Form (level 5)", "Powerful Build"],
    },
    {
        "id": "halfling",
        "label": "Halfling",
...
def main() -> int:
    ...
    write_yaml(
        "dnd5e_skills.yaml",
        {
            ...
            "standard_array_by_class": STANDARD_ARRAY_BY_CLASS,
        },
    )
    if spells:
